...
Install SQL Server and create a database named HospitalDB.
Run the provided SQL script to create the necessary tables (Patients, Doctors, Appointments, Billing).
...
Ensure the connection string in the code points to your local SQL Server instance.
Build and Run the Project:

Press F5 in Visual Studio to build and run the application.
The application will now connect to the database and allow you to manage patients, appointments, and billing.
